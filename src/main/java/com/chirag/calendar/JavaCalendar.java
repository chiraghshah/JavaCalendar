...
public class JavaCalendar { 
	...
	public static void addEvents(){
		...
		while(true){
			...
			if(choiceTz == 'y' || choiceTz == 'Y'){ 
				timeslot=showTimeZones(timeslot);
				break;
			}
			else{
	...
	public static int showTimeZones(int timeslot){
		...
		switch(caseTimeZone)
		{
		case 1: newTimeSlot=checkCurrentTimeZone(userTimeZone,"CST",timeslot);
		break;
		case 2: newTimeSlot=checkCurrentTimeZone(userTimeZone,"EST",timeslot);
		break;
		case 3: newTimeSlot=checkCurrentTimeZone(userTimeZone,"MST",timeslot);
		break;
		case 4: newTimeSlot=checkCurrentTimeZone(userTimeZone,"PST",timeslot);
		break;
		}
		return newTimeSlot;
	}
